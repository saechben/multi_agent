"""Standalone A2A server exposing the multiplication MCP agent."""
...
from agent_system.arithmetic_a2a import MultiplicationAgentExecutor
...
def main() -> None:
    ...
    port = int(os.getenv("A2A_PORT", "9998"))
